export const MoreSmallIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    width="18"
    height="18"
    viewBox="0 0 18 18"
  ...
  >
    ...
    />
    <path
      d="M9 4.49998C9.41421 4.49998 9.75 4.1642 9.75 3.74998C9.75 3.33577 9.41421 2.99998 9 2.99998C8.58579 2.99998 8.25 3.33577 8.25 3.74998C8.25 4.1642 8.58579 4.49998 9 4.49998Z"
      fill="currentColor"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
